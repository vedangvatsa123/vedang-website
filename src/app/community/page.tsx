            ...
            <section id="competencies">
                ...
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Developed and executed a multi-platform content strategy, including research manuscripts, articles, and newsletters, achieving 80M+ LinkedIn views and 40,000 newsletter subscribers.</p>
                    </div>
                     <div>
