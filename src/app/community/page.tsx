            ...
            <section id="competencies">
                ...
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Architected and scaled a 100k+ member professional Web3 community from scratch, fostering a highly engaged network of executives, developers, and enthusiasts.</p>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg">Content Strategy & Creation</h3>
                        <p className="text-muted-foreground mt-1">Developed and executed a multi-platform content strategy, including research manuscripts, articles, and newsletters, achieving 80M+ LinkedIn views and 11k subscribers in 11 editions.</p>
                    </div>
                     <div>
                        <h3 className="font-semibold text-lg">Social Media & Audience Growth</h3>
                        <p className="text-muted-foreground mt-1">Engineered explosive growth on social channels, including scaling one of the largest Telegram channels for Web3 jobs to 55 million post views in its first year.</p>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg">Event Hosting & Public Speaking</h3>
                        <p className="text-muted-foreground mt-1">Hosted high-profile weekly Twitter Spaces with up to 30k live attendees, featuring industry leaders from Microsoft, Pink Floyd, and Big4 firms. Guest lecturer at top universities.</p>
                    </div>
                     <div>
                        <h3 className="font-semibold text-lg">Partnerships & Network Effects</h3>
                        <p className="text-muted-foreground mt-1">Forged strategic partnerships with premier global organizations like Harvard Blockchain Club, ETH Oxford, and Token 2049 to amplify reach and community value.</p>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg">Growth Marketing & Advisory</h3>
                        <p className="text-muted-foreground mt-1">Served as Head of Marketing and Growth Lead for multiple Web3 startups, leveraging community and content as primary organic acquisition channels.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="testimonials">
             ...
             <section id="writings">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="font-semibold text-lg mb-3">Selected Research</h3>
                        <div className="space-y-3">
                           ...
                           <Link href="https://ieeexplore.ieee.org/document/9514979" target="_blank" rel="noopener noreferrer" className="block text-muted-foreground hover:text-primary">Analysis of Global Research Proceedings in AI</Link>
                           <Link href="https://scholar.google.com/citations?user=aW2dd0IAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline mt-2 inline-block">More on Google Scholar</Link>
                        </div>
                    </div>
                     <div>
