...
import { Bot, BrainCircuit, Code, DraftingCompass, GitBranch, Goal, Hand, Lightbulb, MonitorPlay, Palette, Rocket, ShieldCheck, Sigma } from 'lucide-react';
          ...
          <Accordion type="single" collapsible className="w-full" defaultValue="module-1">
            <AccordionItem value="module-1">
              ...
              <AccordionContent className="prose dark:prose-invert max-w-none text-base">
                <p className="lead">
                  <strong>Learning Objective:</strong> Switch your mindset from "writing code" to "managing an AI." You'll learn to think like a product manager, not just a typist, which is the key to getting great results. This module is about establishing the right mental model before you ever write a prompt.
                </p>
                
                <h3>1.1 The Definition: What is Vibe Coding?</h3>
                <p>
                  "Vibe Coding" isn't just a buzzword; it's a fundamental shift in how we create things with computers. Coined by Andrej Karpathy, a founding member of OpenAI, in early 2025, it describes a new, conversational relationship with the machine. Let's break down the difference.
                </p>
                ...
                <p>
                  The goal isn't just to write code faster. As Karpathy put it, the ultimate goal is to "forget that the code even exists." You are meant to focus entirely on the product vision, the user experience, and the business logic. The AI becomes an extension of your creative will, a tireless junior developer that handles the tedious implementation details, allowing you to stay in a state of creative flow. It’s about moving from a world of rigid instructions to one of intuitive conversation.
                </p>
                ...
                <p>
                  To succeed in Vibe Coding, remember this mnemonic: <strong>"The Friendly Cat Dances Constantly."</strong> It's a silly phrase, but it covers the five pillars of effective AI-assisted development. This framework will be your guide through the entire process.
                </p>
                <div className="space-y-4 my-6">
            ...
            <AccordionItem value="module-2">
              ...
              <AccordionContent className="prose dark:prose-invert max-w-none text-base">
                <p className="lead">
                  <strong>Learning Objective:</strong> Choose the right tool for your project. Your toolbox determines your speed, capabilities, and how much fun you have. There's no single "best" tool, only the right tool for the job. We'll explore the landscape from beginner-friendly visual builders to professional-grade code editors.
                </p>

                <h3>2.1 The Big Choice: Cloud vs. Local</h3>
                ...
                <h3>2.2 A Tour of Your Options</h3>
                ...
                <Card className="my-6">
                    ...
                    <CardContent className="flex flex-col sm:flex-row items-start gap-4">
                        <Image src="https://picsum.photos/seed/lovable/150/100" alt="Lovable.dev interface" width={150} height={100} className="rounded-md m-0 flex-shrink-0" data-ai-hint="dashboard interface" />
                        <div>
                ...
                <Card className="my-6">
                    <CardHeader>
                     ...
                     <CardContent className="flex flex-col sm:flex-row items-start gap-4">
                        <Image src="https://picsum.photos/seed/replit/150/100" alt="Replit interface" width={150} height={100} className="rounded-md m-0 flex-shrink-0" data-ai-hint="code editor" />
                        <div>
                ...
                <Card className="my-6">
                     ...
                     <CardContent className="flex flex-col sm:flex-row items-start gap-4">
                        <Image src="https://picsum.photos/seed/claude/150/100" alt="Cursor editor interface" width={150} height={100} className="rounded-md m-0 flex-shrink-0" data-ai-hint="dark code editor" />
                        <div>
                 ...
                 <Card className="my-6">
                     ...
                     <CardContent className="flex flex-col sm:flex-row items-start gap-4">
                         <Image src="https://picsum.photos/seed/firebase/150/100" alt="Firebase Studio interface" width={150} height={100} className="rounded-md m-0 flex-shrink-0" data-ai-hint="cloud dashboard" />
                        <div>
            ...
            <AccordionItem value="module-3">
              ...
              <AccordionContent className="prose dark:prose-invert max-w-none text-base">
                <p className="lead">
                  <strong>Learning Objective:</strong> Learn to write the "documents" that guide the AI. In Vibe Coding, the quality of your prompt determines the quality of your product. This is the single most important skill to master. This isn't about "prompt hacks"; it's about structured communication.
                </p>

                <h3>3.1 The PRD (Product Requirements Document)</h3>
                <p>
                  Never start a project with an empty chat box. You need a plan. In the product world, this is called a PRD. For us, it's a simple text file that tells the AI exactly what to build. It's your architectural blueprint, and it's essential.
                </p>
                <ul>
                  <li>
                    <strong>Why it's critical:</strong> The saying is "Garbage in, garbage out." If your prompt is vague ("make a cool app"), your app will be a generic, useless mess. A PRD forces you to clarify your own thinking.
                  </li>
                  <li>
                    <strong>How to Generate One (The Meta-Skill):</strong> You don't have to write it from scratch! You can use an AI to help you create the plan for your *other* AI. This is a common and powerful workflow. Prompt another AI like ChatGPT or Claude:
                    <blockquote>
                      "You are an expert product manager. I want to build a [Recipe App for users with food allergies]. Your job is to interview me to create a detailed Product Requirements Document (PRD). Ask me clarifying questions about features, user roles, data models, and design to ensure the requirements are complete and unambiguous. Start by asking me the first question."
                    </blockquote>
                ...
                <h3>3.2 The Perfect Prompt Structure (GCES Framework)</h3>
                <p>
                  When you're ready to prompt your coding tool (like Replit or Firebase Studio), use a structured approach for maximum clarity. A great model to use is the GCES framework: Goal, Context, Expectations, Source.
                </p>
                <div className="space-y-4 my-6">
                ...
                <p>
                  Vibe coding is not a one-shot command; it's a conversation. Great products are built through iteration. You must embrace this loop. It's like sculpting: you start with a block of stone and slowly chip away until you have a masterpiece.
                </p>
                <ol className="my-6">
                  <li>
                    <strong>Prompt:</strong> Give your clear, structured instruction using the GCES framework. "Build the login page with email and password fields, plus a 'Login' button. Use our brand's primary blue for the button."
                  </li>
                  <li>
                    <strong>Review:</strong> The AI generates the page. It's functional. You look at it and think, "Okay, the button is there, but it's too small and the color is a bit too bright. It doesn't match our calm vibe."
                  </li>
                  <li>
                    <strong>Refine:</strong> You provide specific, actionable feedback in your next prompt. Don't say "it's wrong." Say *what* to change. "The login button is a good start, but let's refine it. Make it 20% larger and use a slightly darker shade of blue (#4A90E2). Also, add a 'Forgot Password?' link directly below it in a smaller, gray font."
                  </li>
                  <li>
                    <strong>Repeat:</strong> Continue this cycle of prompting and refining. Each loop gets you closer to your perfect product. This is where the "vibe" is shaped, in the small details and adjustments. Don't be afraid to go through 5, 10, or 20 iterations on a single component. That's not failure; that's the process.
                  </li>
                </ol>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="module-4">
              ...
              <AccordionContent className="prose dark:prose-invert max-w-none text-base">
                <p className="lead">
                  <strong>Learning Objective:</strong> Apply your knowledge to build a real, functional web application. We'll walk through examples using different tools to show how the core concepts of Vibe Coding apply everywhere. This is where theory meets practice.
                </p>
                ...
                <ol>
                  ...
                  <li>
                    <strong>Initial Prompt (Your PRD):</strong> In the chat interface, paste in a clear and detailed PRD based on our GCES framework.
                ...
                <h4>Path 2: The Code-First Method (using Replit or a Local Editor)</h4>
            ...
            <AccordionItem value="module-5">
              ...
              <AccordionContent className="prose dark:prose-invert max-w-none text-base">
                <p className="lead">
                  <strong>Learning Objective:</strong> Learn how to turn your Vibe Coding hobby into a secure product or a viable career path. Building is the first step; creating sustainable value is the goal. This module is about moving from prototype to professional.
                </p>
                ...
                <ul>
                  <li>
                    <strong>The Risk:</strong> An AI might accidentally hardcode your private API keys directly into the public-facing code (a huge security breach). It might generate a login function with weak password requirements. It could create a database query that is vulnerable to attack.
                  </li>
                  <li>
                    <strong>The Fix: The Rule File.</strong> You must create a rule file. Different tools have different names for it (`.cursorrules`, `guardrails.md`, or the `CLAUDE.md` file). This file is automatically read by the AI before every single action. It is your permanent set of instructions that the AI cannot ignore.
                  </li>
                  <li>
                    <strong>What to write in your rule file (Your "Company Policy"):</strong>
                    <blockquote>
                ...
                <ul>
                  <li>
                    <strong>SaaS (Software as a Service):</strong> This is the most common path. Build a niche tool that solves a specific problem for a specific group of people, and charge a monthly subscription fee. Don't try to build the next Facebook. Instead, use your recipe generator skills to build a "Weekly Meal Planner for Vegan Athletes" and charge $10/month. Find a small, painful problem and solve it beautifully.
                  </li>
                  <li>
                    <strong>Example from the Real World:</strong> Peter Levels, a well-known indie developer, vibe-coded an AI-powered interior design app and generated over $1 million in revenue in its first month. He didn't spend six months writing code; he spent his time understanding what users wanted, marketing the product, and letting the AI handle the implementation.
                  </li>
                  <li>
                    <strong>Freelancing and Consulting:</strong> Your new superpower is speed. You can now use tools like Lovable and Replit to build full-stack applications for clients in a fraction of the time it would take a traditional developer. You can charge a premium for your speed and deliver a working prototype in days, not months. This is incredibly valuable to businesses that want to test ideas quickly.
                  </li>
                </ul>
