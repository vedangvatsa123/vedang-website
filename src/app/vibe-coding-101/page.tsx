...
import { Bot, BrainCircuit, Code, DraftingCompass, GitBranch, Goal, Hand, Lightbulb, MonitorPlay, Palette, Rocket, ShieldCheck, Sigma, Star, BookOpen, ExternalLink } from 'lucide-react';
...
const referenceLinks = [
    { 
        ...
        links: [
            { name: 'Studio Docs', url: 'https://firebase.google.com/docs/studio' },
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent className="prose dark:prose-invert max-w-none text-base pt-2">
                                <p>"Vibe Coding" isn't just a buzzword; it's a fundamental shift in how we create things with computers. Coined by Andrej Karpathy, a founding member of OpenAI, it describes a new, conversational relationship with the machine.</p>
                                 ...
                                 <Card className="my-6">
                                     ...
                                     <CardContent className="flex flex-col sm:flex-row items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground"><strong>Workflow:</strong> It's a unique Vibe Coding tool that adds a crucial safety step. It generates a <strong>"Blueprint"</strong> (a detailed plan of all file changes) that you review and approve *before* it writes any code. This gives you maximum control and prevents the AI from making unwanted changes. It's like having an architect show you the blueprints before the construction crew starts working.</p>
                                            <p className="text-sm text-muted-foreground"><strong>Deployment:</strong> It deploys to Google Cloud, providing enterprise-grade security, scalability, and performance automatically, making it ideal for projects that you intend to grow into serious businesses.</p>
                                        </div>
                                    </CardContent>
                                </Card>
                            </AccordionContent>
                            ...
                            <AccordionContent className="prose dark:prose-invert max-w-none text-base pt-2">
                                ...
                                <ul>
                                  ...
                                  <li><strong>How to Generate One (The Meta-Skill):</strong> You don't have to write it from scratch! You can use an AI to help you create the plan for your *other* AI. This is a common and powerful workflow. Prompt another AI like ChatGPT or Claude:
                                    <blockquote className="border-l-4 border-primary/50 pl-4 italic">"You are an expert product manager. I want to build a [Recipe App for users with food allergies]. Your job is to interview me to create a detailed Product Requirements Document (PRD). Ask me clarifying questions about features, user roles, data models, and design to ensure the requirements are complete and unambiguous. Start by asking me the first question."</blockquote>
                                ...
                                <ol>
                                  ...
                                  <li><strong>Connect Frontend to Backend (The Final Step):</strong>
                                   ...
                                   <li><strong>Publishing:</strong> With Replit, you click "Deploy." With a local setup, you connect your project to a service like Vercel or Netlify.
                                    <blockquote className="border-l-4 border-primary/50 pl-4 italic">"Generate a `vercel.json` configuration file to deploy this Next.js app. Set the appropriate build commands and output directory."</blockquote>
                                  </li>
                                </ol>
