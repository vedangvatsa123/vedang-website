...
summary: 'Examining the fundamental contradictions in singularity predictions and what we can and cannot know about post-singularity futures.'
---
...
This is the core problem. Any forecast about the singularity is probably wrong, simply because forecasting presupposes a level of intelligence that the post-singularity world will exceed.
...
This means any detailed prediction about the singularity is probably nonsense. Not because the predictor is stupid, but because the problem is literally epistemically impossible. You can't predict the unpredictable. You can't forecast the unfathomable.
