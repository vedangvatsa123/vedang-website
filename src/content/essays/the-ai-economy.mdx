...
The [IMF's January 2024 staff note](https://www.imf.org/en/Publications/Staff-Discussion-Notes/Issues/2024/01/14/Gen-AI-Artificial-Intelligence-and-the-Future-of-Work-SDN2024001) estimated that nearly 40 percent of global employment is exposed to AI, rising to 60 percent in advanced economies. [Goldman Sachs projected](https://www.goldmansachs.com/insights/articles/generative-ai-could-raise-global-gdp-by-7-percent) that up to 300 million full-time jobs across the United States and Europe may be affected by generative AI, while also suggesting the technology could add roughly $7 trillion to global GDP over a decade. The [World Economic Forum's 2025 Future of Jobs Report](https://www.weforum.org/publications/the-future-of-jobs-report-2025/), surveying over 1,000 employers across 55 economies, projected 170 million new jobs created by 2030 against 92 million displaced, a net gain of 78 million.
...
Here is where the picture gets genuinely complicated. A [March 2026 Goldman Sachs note](https://fortune.com/2026/03/03/goldman-sachs-ai-productivity/) found no meaningful relationship between AI adoption and economy-wide productivity at the aggregate level. But firms that measured AI impact on specific tasks reported a median gain of around 30 percent.
...
[Daron Acemoglu of MIT](https://fortune.com/2024/08/06/markets-overestimated-ai-productivity-says-mit-economist/) has argued that generative AI may produce a modest GDP increase of only 1.1 to 1.6 percent over the next decade. He estimates that only about 4.6 percent of tasks can be meaningfully impacted in the near term. Goldman Sachs [has responded](https://www.aei.org/articles/) that Acemoglu's assumptions are based on current capabilities, which are advancing at a pace that makes static projections risky.
