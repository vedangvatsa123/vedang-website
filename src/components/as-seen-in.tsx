...
const asSeenInLogos = [
    ...
    { name: 'KPMG', logo: '/images/press/1718209067639.png' },
    ...
    { name: 'YourStory', logo: '/images/press/image-23.png' },
    { name: 'The Print', logo: '/images/press/image-24.png' },
    ...
    { name: 'News Outlet 4', logo: '/images/press/image-37.png' },
    { name: 'News Outlet 7', logo: '/images/press/image-42.png' },
    { name: 'News Outlet 9', logo: '/images/press/image-48.webp' },
    { name: 'News Outlet 10', logo: '/images/press/image-58.png' },
